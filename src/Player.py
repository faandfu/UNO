...
class Player(ABC):
    @abstractmethod
    def play_card(
        self, current_card: Card, compatible_cards: List[Card]
    ) -> Optional[Card]:
        pass
    ...
    @abstractmethod
    def move(self, current_card: Card) -> Union[Card, None]:
        pass


class UserPlayer(Player):
    def __init__(
        self, user_input: UserInput, card_stack: CardStack, display: Display, name: str
    ) -> None:
    ...
    def play_card(
        ...
        card: Optional[Card] = self.user_input.select_card(self.cards)
...
class ComputerPlayer(Player):
    ...
    def play_card(self, current_card: Card, compatible_cards: List[Card]):
